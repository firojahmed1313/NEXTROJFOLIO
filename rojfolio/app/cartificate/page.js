    ...
    <section className=" bg-stone-700 m-4 rounded-lg flex flex-wrap p-4">

      {
        cartificates?.map((cartificate) => {
          return (
            <div className=" w-[30%]  h-fit m-auto rounded-lg bg-neutral-800  hover:bg-neutral-900 flex flex-col items-center justify-center  pb-4 pt-4 mb-3" key={cartificate.name}>
