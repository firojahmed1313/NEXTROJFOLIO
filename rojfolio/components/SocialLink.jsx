        ...
        <>
            <section className="flex justify-evenly items-center mb-10">
                <Link href="https://www.linkedin.com/in/md-firoj-ahmed-8209a01bb/" passHref={true} target="_blank">
                    <button
                        className="group flex justify-center drop-shadow-xl bg-gradient-to-r from-gray-800 to-black text-white font-semibold hover:translate-y-3 transition-all duration-500 hover:from-[#331029] hover:to-[#310413] borde rounded-xl  shadow-md shadow-slate-600 p-3 mt-1 hover:bg-red-500"
                    >
